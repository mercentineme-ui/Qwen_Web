...
export const defaultData: PortfolioData = {
  ...
  core: [
    ...
    { id: "d4", num: "04", name: "CINEMATIC STORYTELLING", icon: "cinematic", blurb: "Camera language, pacing, sequence design and visual storytelling built for cinematic continuity — beats that cut together, not just images that look good alone.", tags: ["CAMERA", "PACING", "CONTINUITY"] },
  ...
  build: {
    ...
    reveal: {
      image: slot("REVEAL FRAME", "image", ["ADD IMAGE", "VERTICAL UPLOAD"]),
  ...
  contact: {
    ...
    portrait: slot("PORTRAIT", "image", ["ADD IMAGE", "9 : 16"]),
  },
};
