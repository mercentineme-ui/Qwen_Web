...
function Dossier({ entry, kind }: { entry: ArcEntry; kind: "CHARACTER" | "WORLD" }) {
  return (
    <div key={entry.id} className={`career-wipe-in mat-inner mat-texture rounded-xl border border-[var(--line)] p-5 sm:p-6 h-full ${kind === "CHARACTER" ? "mat-alice" : "mat-dossier-theme"}`}>
