...
/* one short synthesized "dropped metal tea tin" ping (~1s, played once) — no external asset */
function playTin() {
  try {
...
export default function ShowReel() {
  ...
  const poke = useCallback(() => {
    setMoving(true);
    setCapturing(false); /* creature releases immediately when dragging resumes */
